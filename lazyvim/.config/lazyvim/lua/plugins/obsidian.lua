return {
  ...
  keys = {
    { "<leader>nn", "<cmd>Obsidian new_from_template<cr>", desc = "New note" },
    { "<leader>no", "<cmd>Obsidian open<cr>", desc = "Open note" },
    ...
    { "<leader>nt", "<cmd>Obsidian tags<cr>", desc = "Show tags" },
    ...
    { "<leader>nl", "<cmd>Obsidian links<cr>", desc = "Collect all links" },
